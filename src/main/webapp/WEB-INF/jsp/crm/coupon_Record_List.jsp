...
<head>
    ...
    function showPage(number){
    	...
    	window.location.href="/crm/cityMerchant/couponRecord.html?pageNo="+number+"&merchantId="+id;
	}
    </script>
</head>
<body>
...
<div class="right-bottom">
	<div class="right-top" style="left: 280px;">
		<div class="tag-box">
			...
			<a class="tag-list" href="/crm/cityMerchant/couponRecord.html?merchantId=${merchantId }">优惠券记录详情</a>
		</div>
