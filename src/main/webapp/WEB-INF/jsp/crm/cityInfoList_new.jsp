...
<head>
    ...
    function showPage(number){
		...
		window.location.href="/crm/info/list.html?pageNo="+number+"&pid="+pid+"&linkTel="+linkTel+"&daterange="+daterange;
	}
...
<div class="right-bottom">
	<div class="right-top" style="left: 280px;">
        <div class="input-list">
            <input type="text" id="linkTel" name="linkTel" value="${linkTel }">
            <span class="search-icon ripple-event" onclick="showPage(1)"></span>
            <div class="setDateBox">
                <input type="text" name="daterange" id="daterange" class="daterange" value="${dateTime }">
	...
	<div class="a_content">
     <div class="tab-list">
            <ul>
                <li class="money_on  ripple-event" onclick="showList(${pid})">正常</li>
                <%-- <li class="ripple-event" onclick="stopList(${pid})">禁用</li> --%>
            </ul>
        </div>
	    	<table class="add_content">
	    		...
	    		<tr>
	    			...
	    			<td>
	    				...
	    				<%-- <a class="blue add-margin" data-type="1" href="###" onclick="stop(${item.id})">禁用</a> --%>
	    			</td>
	    		</tr>
	    		</c:forEach>
	    	</table>
  	...
  	<div class="layer_content">
  	  ...
  	  <div class="mian_content">
  	  	<div class="add_left">
  	  		<div class="add_box">
  		  		<div class="add_c">
  		  			<ul class="add_value">
  		  				<li>
  		  					<p class="add_text4"><i class="add_icon add_icon4"></i><span id="add4_lra">1</span></p>
  		  					<p class="add_text3">提货系数</p>
  		  				</li>
  		  				<li>
  		  					<p class="add_text4"><i class="add_icon add_icon5"></i><span id="add4_lrb">0</span></p>
  		  					<p class="add_text3">区域利润系数</p>
  		  				</li>
  		  				<li>
  		  					<p class="add_text4"><i class="add_icon add_icon6"></i><span id="add4_lrc">0</span></p>
  	  	...
  	  	<div class="add_right">
  	  			<ul class="addf_lr">
  	  				<li>
  	  					<p><input type="text" id="edit4_lra" name="fixateProfit" value="1"  data-txt="number" oninput="edit(this.id,'add4_lra')"  placeholder="提货系数"></p>
  	  				    <p><input type="text" id="edit4_lrb" name="goodsProfit" value="0" data-txt="number"  oninput="edit(this.id,'add4_lrb')" placeholder="区域系数"></p>
  	  				</li>
  	  				<li>
