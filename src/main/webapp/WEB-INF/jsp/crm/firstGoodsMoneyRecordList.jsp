...
<head>
    ...
    function showPage(number){
    	...
    	window.location.href="/crm/cityMerchant/firstGoodsMoneyRecordList.html?pageNo="+number+"&merchantId="+id;
	}
    </script>
</head>
<body>
...
<div class="right-bottom">
	<div class="right-top" style="left: 280px;">
		<div class="tag-box">
			...
			<a class="tag-list" href="/crm/cityMerchant/firstGoodsMoneyRecordList.html?merchantId=${merchantId }">追加货款详情</a>
		</div>
	   	...
	   	<table class="balanceDetail">
	   		...
	   		<c:forEach items="${records }" var="record">
	   			<tr>
		   			...
		   			<td>
		   				<fmt:formatNumber type="currency" maxFractionDigits="2" minFractionDigits="2" value="${record.firstGoodsMoneyBalanceAfter }"/>
		   			</td>
	   			</tr>
	   		</c:forEach>
	   		</tbody>
