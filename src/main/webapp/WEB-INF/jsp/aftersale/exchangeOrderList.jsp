        ...
        <ul class="partlist">
            ...
            <li>
                ...
                <div class="inforbox selectinforbox">
                    ...
                    <div class="row">
                        <input type="text" class="personname" name="queryStr" placeholder="订单号、用户名">
                        ...
                        <table class="refundlist">
                            ...
                            <c:forEach items="${dataList }" var="sale" varStatus="qv">
	                            <tr>
	                                ...
	                                <c:if test="${sale.service.status == 31 }">
	                                	配货中
	                                </c:if>
	                                <c:if test="${sale.service.status == 32 }">
	                                	拒绝
	                                </c:if>
	                                ...
	                                <c:if test="${sale.service.status == 10 }">
	                                	...
	                                	<a href="/aftetSale/toOrderView.html?id=${sale.service.id }&queryType=2" class="link">详情</a>
	                                </c:if>
	                                <c:if test="${sale.service.status == 31 }">
	                                	<a href="#" class="link" onclick="agree(${sale.service.id})">发货</a>
	                                	<a href="/aftetSale/toOrderView.html?id=${sale.service.id }&queryType=2" class="link">详情</a>
	                                </c:if>
