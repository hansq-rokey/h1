   						...
   						<tr>
							...
							<td style="max-width:200px;min-width:100px;">${order.remark }</td>
       						...
       						<td>
       							...
       							<c:if test="${order.status!=80 }">
	       							<a href="#" class="link" onclick="toUpdateStatus('${order.orderNumber}')">确认订单</a>
       							</c:if>
       							<a href="/activityOrder/detail.html?orderNumber=${order.orderNumber }" class="link">详情订单</a>
       						</td>
       					</tr>
   					</c:when>
   				<c:otherwise>
