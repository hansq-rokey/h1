...
<body>
    <section>
        <div class="content" style="margin-top: 20px;">
        	<form action="/noEffectOrder/list.html" method="post">
        ...
        <ul class="partlist">
            <li>
                <a href="/noEffectOrder/list.html"><span class="switch <c:if test="${status==null}">switched</c:if>">全部</span></a>
                	<c:if test="${status==null}">
                		<div class="inforbox selectinforbox">
                			<jsp:include page="no_effect_order_list_status.jsp"></jsp:include>
                			<jsp:include page="../include/pages.jsp"></jsp:include>
                		</div>
                	</c:if>
            </li>
            <li>
                <a href="/noEffectOrder/list.html?status=20"><span class="switch <c:if test="${status==20}">switched</c:if>" >待发货</span></a>
                	<c:if test="${status==20 }">
                		<div class="inforbox selectinforbox">
                			<jsp:include page="no_effect_order_list_status.jsp"></jsp:include>
                			<jsp:include page="../include/pages.jsp"></jsp:include>
            ...
            <li>
                <a href="/noEffectOrder/list.html?status=30"><span class="switch <c:if test="${status==30}">switched</c:if>" >配货中</span></a>
                	<c:if test="${status==30 }">
                		<div class="inforbox selectinforbox">
                			<jsp:include page="no_effect_order_list_status.jsp"></jsp:include>
                			<jsp:include page="../include/pages.jsp"></jsp:include>
            ...
            <li>
                <a href="/noEffectOrder/list.html?status=40"><span class="switch <c:if test="${status==40}">switched</c:if>" >已发货</span></a>
                	<c:if test="${status==40 }">
                		<div class="inforbox selectinforbox">
                			<jsp:include page="no_effect_order_list_status.jsp"></jsp:include>
                			<jsp:include page="../include/pages.jsp"></jsp:include>
            ...
            <li>
                <a href="/noEffectOrder/list.html?status=50"><span class="switch <c:if test="${status==50}">switched</c:if>" >已签收</span></a>
                	<c:if test="${status==50 }">
                		<div class="inforbox selectinforbox">
                			<jsp:include page="no_effect_order_list_status.jsp"></jsp:include>
                			<jsp:include page="../include/pages.jsp"></jsp:include>
...
function toUpdate(orderNumber,shouldPayMoney){//总价格
    var tbody="";
      $.ajax({
           url: "/noEffectOrder/toUpdate.html",
           type: "post",
...
function update(){
    ...
    $.ajax({
       url: "/noEffectOrder/updatePrice.html",
...
/* function computed(id,pic){
    if(pic > 0){
         $.ajax({
             url: "/noEffectOrder/updateItemPrice.html?id="+id+"&itemPrice="+pic,
             type: "post",
             dataType:"json",
             cache:false,
             success: function(obj){
