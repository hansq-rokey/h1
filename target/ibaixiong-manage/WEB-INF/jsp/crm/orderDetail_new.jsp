...
<div class="right-bottom">
    ...
    <div class="a_content">
	    <div class="tab-list" style="top: -135px;">
	      ...
	      <div class="table_wrap">
			<div class="Details_left">
				...
				<div class="table-responsive or_scorll">
					<table class="table">
						<thead>
							<tr class="table_h80">
					     		<th>序号</th>
		    ...
		    <div class="box_Operation_listright" style="margin-top:20px">
