...
<head>
    ...
    <script type="text/javascript">
    	...
    	$(document).ready(function() {
    		...
    		if(error == 3){
    			alert("设置价格失败，省代未设置价格，需要先设置省代价格");
    		}
    		if(error == 4){
    			alert("设置价格失败，设置价格过小，要设置超过省代价格");
    		}
    		if(error == 5){
    			alert("设置价格失败，设置价格过大，要设置值超过了下级设置的值");
    		}
    	});
    </script>
</head>
<body>
    <section>
        <ul class="partlist" style="border-bottom: 0px;margin-top: -15px;">
            <li>
                <div class="inforbox selectinforbox">
                	<div class="content">
                    	<form action="/crm/cityMerchant/setModelFormatMonyelist.html" method="post">
...
<form action="/crm/cityMerchant/savePrice.html" onsubmit="return check()"  method="post">
