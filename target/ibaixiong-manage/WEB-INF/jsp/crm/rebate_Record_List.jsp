...
<head>
    ...
    <title>返利金额记录详情</title>
    <script type="text/javascript">
    function showPage(number){
    	var id = $("#merchantId").val();
    	window.location.href="/crm/cityMerchant/rebateRecord.html?pageNo="+number+"&merchantId="+id;
	}
    </script>
</head>
<body>
...
<div class="right-bottom">
	<div class="right-top" style="left: 280px;">
		<div class="tag-box">
			...
			<a class="tag-list" href="/crm/cityMerchant/rebateRecord.html?merchantId=${merchantId }">返利金额记录详情</a>
		</div>
	   	...
	   	<table class="balanceDetail">
	   		...
	   		<c:forEach items="${records }" var="record">
	   			<tr>
		   			...
		   			<td class="editor-color">${record.proportion }</td>
		   			<td class="editor-color">${record.money }</td>
		   			<td class="editor-color">${record.downCityName==null?"":record.downCityName }</td>
		   			<td>${record.remark }</td>
