...
<body>
    <section>
        <div class="content" style="margin-top: 20px;">
            <form action="/tbOrder/list.html" method="post">
        ...
        <ul class="partlist">
            <li>
                <a href="/tbOrder/list.html"><span class="switch <c:if test="${status==null}">switched</c:if>">全部</span></a>
                    <c:if test="${status==null}">
                        <div class="inforbox selectinforbox">
                            <jsp:include page="tb_order_list_status.jsp"></jsp:include>
                            <jsp:include page="../include/pages.jsp"></jsp:include>
                        </div>
                    </c:if>
            </li>
            <li>
                <a href="/tbOrder/list.html?status=20"><span class="switch <c:if test="${status==20}">switched</c:if>" >待发货</span></a>
                    <c:if test="${status==20 }">
                        <div class="inforbox selectinforbox">
                            <jsp:include page="tb_order_list_status.jsp"></jsp:include>
                            <jsp:include page="../include/pages.jsp"></jsp:include>
            ...
            <li>
                <a href="/tbOrder/list.html?status=30"><span class="switch <c:if test="${status==30}">switched</c:if>" >配货中</span></a>
                    <c:if test="${status==30 }">
                        <div class="inforbox selectinforbox">
                            <jsp:include page="tb_order_list_status.jsp"></jsp:include>
                            <jsp:include page="../include/pages.jsp"></jsp:include>
            ...
            <li>
                <a href="/tbOrder/list.html?status=40"><span class="switch <c:if test="${status==40}">switched</c:if>" >已发货</span></a>
                    <c:if test="${status==40 }">
                        <div class="inforbox selectinforbox">
                            <jsp:include page="tb_order_list_status.jsp"></jsp:include>
                            <jsp:include page="../include/pages.jsp"></jsp:include>
            ...
            <li>
                <a href="/tbOrder/list.html?status=50"><span class="switch <c:if test="${status==50}">switched</c:if>" >已签收</span></a>
                    <c:if test="${status==50 }">
                        <div class="inforbox selectinforbox">
                            <jsp:include page="tb_order_list_status.jsp"></jsp:include>
                            <jsp:include page="../include/pages.jsp"></jsp:include>
...
function toUpdateStatus(orderNumber){
    ...
    $.ajax({
           url: "/tbOrder/updateStatus.html?orderNumber="+orderNumber,
           type: "post",
           dataType:"json",
           cache:false,
           success: function(obj){
